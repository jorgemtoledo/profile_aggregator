...
RSpec.describe Github::ProfileImporter do
  subject(:importer) { described_class.new(username) }
  ...
  describe "#call" do
    context "when profile does not exist" do
      it "creates profile, profile_stat and short_url" do
        ...
        expect(profile.github_url).to eq("https://github.com/octocat")
        ...
        expect(profile.short_url.target_url).to eq("https://github.com/octocat")
      end
    end
  end
end
